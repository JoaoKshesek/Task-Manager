        ...
        <CardContent sx={{
          ...
          <Grid container spacing={2} mt={1}>
            ...
            <Grid container spacing={2} pl={2} mt={2}>
              <Grid item xs={1}>
                <Button size="small" sx={{ background: 'linear-gradient(0deg, rgba(40,118,105,1) 0%, rgba(54,156,148,1) 100%)'}} variant="contained" onClick={handleEditar}>Salvar</Button>
              </Grid>  
              <Grid item xs={1} ml={3}>  
                <Button size="small" sx={{ color: '#095852', borderColor: '#095852'}} variant="outlined" onClick={handleCloseEditar}>Cancelar</Button>  
              </Grid>
            </Grid>  
          </Grid>
        </CardContent>
